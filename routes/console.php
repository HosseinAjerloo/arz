...
\Illuminate\Support\Facades\Schedule::job(VoucherBankArrangementJob::class)->daily();
\Illuminate\Support\Facades\Schedule::command('queue:work --stop-when-empty --queue VoucherBankArrangementJob')->runInBackground()->daily();
