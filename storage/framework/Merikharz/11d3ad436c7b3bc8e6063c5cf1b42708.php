...
<?php $__env->startSection('script-tag'); ?>
    ...
    <script>
        $(document).ready(function () {
            let sendBtn = $(".send");
            let tokenCSRF = "<?php echo e(csrf_token()); ?>";
            $(sendBtn).click(function (event) {
                let mobile=$(".mobile").val();
                event.preventDefault();
                $.ajax({
                    'type': "POST",
                    'url': "<?php echo e(route('createCode')); ?>",
    ...
    <script>
        function time(message){
           var sendBtn=document.getElementsByClassName("send")[0];
            ...
            var now = new Date("<?php echo e(\Carbon\Carbon::now()->subMinutes(3)->toDateTimeString()); ?>")
...
<?php echo $__env->make('Auth.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\merikhArz\resources\Merikharz/Auth/register.blade.php ENDPATH**/ ?>