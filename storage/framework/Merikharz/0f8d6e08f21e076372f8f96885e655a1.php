...
<section class="w-full relative flex items-center justify-center">
    <img src="<?php echo e(asset('merikhArz/src/images/mainImg.png')); ?>" alt="" class="object-cover bg-center h-full w-full">
...
<section class="w-full flex flex-wrap justify-between mt-4">
    <div class="w-[48%] h-40 bg-gradient-to-b from-FFC98B to-FFF5EA rounded-md flex justify-center items-center flex-col mt-2">
        <img src="<?php echo e(asset("merikhArz/src/images/perfectMoneyIcon.png")); ?>" alt="" class="object-cover">
    ...
    <div class="w-[48%] h-40 bg-gradient-to-b from-FFBEBE to-FFF5EA rounded-md flex justify-center items-center flex-col mt-2">
        <img src="<?php echo e(asset('merikhArz/src/images/server.png')); ?>" alt="" class="object-cover">
    ...
    <div class="w-[48%] h-40 bg-gradient-to-b from-8EBFFC to-E5F1FF rounded-md flex justify-center items-center flex-col mt-2">
        <img src="<?php echo e(asset('merikhArz/src/images/host.png')); ?>" alt="" class="object-cover">
...
<section class="p-10 flex px-3 space-x-reverse space-x-3">
    <div>
        <img src="<?php echo e(asset("merikhArz/src/images/checked.png")); ?>" alt="" class="object-cover">
    </div>
    <div>
...
<section
    ...
    <form action="" class="mt-10 space-y-8">
        <div class="flex bg-white w-full border rounded-md p-2 ">
            <img src="<?php echo e(asset('merikhArz/src/images/svgPhone.svg')); ?>" alt="" class="ml-2">
        ...
        <div class="flex bg-white w-full border rounded-md p-2 ">
            <img src="<?php echo e(asset('merikhArz/src/images/key.svg')); ?>" alt="" class="ml-2">
            <input type="text" placeholder="کلمه عبور انخابی را وارد فرمایید!" class="placeholder:text-mini-base placeholder:text-black px-2 bg-transparent
                outline-none">
        </div>
...
<?php echo $__env->make('Panel.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\SainaArz\resources\Merikharz/index.blade.php ENDPATH**/ ?>