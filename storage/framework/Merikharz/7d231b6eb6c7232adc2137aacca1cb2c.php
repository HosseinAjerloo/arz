    ...
    <nav
                        ...
                        <ul class="w-full">
                            <li class="text-sm h-8 border-b-base-font-color border-dashed border-b text-black/75 py-1.5 flex items-center space-x-reverse space-x-2">
                                ...
                                <p>
                                    ...
                                    <?php echo e(\Illuminate\Support\Facades\Auth::user()->fullName); ?> (<?php echo e(\Illuminate\Support\Facades\Auth::user()->mobile); ?>)
                                </p>
                            </li>
                            <li class="text-sm h-8 border-b-base-font-color border-dashed border-b text-black/75 py-1.5 flex items-center space-x-reverse space-x-2">
                            ...
                            <li class="text-sm h-8  text-black/45 px-1.5 py-6 flex items-center">
                                <div
                                    ...
                                    <a href="<?php echo e(route('logout')); ?>"> خروج از حساب</a>
                                </div>
                            </li>
        ...
        <?php if(auth()->guard()->guest()): ?>
            <div
                ...
                <a href="<?php echo e(route('login.index')); ?>">ورود / ثبت نام</a>
            </div>
        <?php endif; ?>
        <!-- end  user Guest   -->
...
<?php /**PATH H:\merikhArz\resources\Merikharz/Panel/Layout/header.blade.php ENDPATH**/ ?>