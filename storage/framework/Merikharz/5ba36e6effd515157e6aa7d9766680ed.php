<?php $__env->startSection('content'); ?>
    ...
    <section class=" w-full border-2 border-black/15 rounded-lg mt-4">
        ...
        <article class="flex flex-col justify-start space-y-2 p-2 ">
            <form action="<?php echo e(route('panel.transmission')); ?>" class="space-y-4" id="form" method="post">
                <?php echo csrf_field(); ?>
                ...
                <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="flex items-center justify-center action">
                        <button type="button" onclick="selectBank(<?php echo e($bank->id); ?>)"
                            ...
                            <span class="w-48 text-mini-base leading-4">پرداخت با <?php echo e($bank->name??''); ?></span>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function commission() {
            return "<?php echo e($dollar->DollarRateWithAddedValue()); ?>";
        }


        $(".customPayment").on('input', function () {
            let payment = $('.customPayment').val();
            if (payment <= Number("<?php echo e(env('Daily_Purchase_Limit')); ?>")) {
                ...
                if (payment.match(/(([0-9])?((\.)?)([0-9]{1,2}))/gm)) {
                    ...
                    message += "<?php echo e(env('Daily_Purchase_Limit')); ?>" + " .باشد ";
                    errors(message);
                    $('.customPayment').val('')
                }
            } else {
