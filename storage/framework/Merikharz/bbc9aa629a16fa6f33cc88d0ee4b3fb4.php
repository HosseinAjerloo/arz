...
<form class="flex flex-col justify-center items-center space-y-6 py-2 pb-6  border-b border-black/40" method="POST" action="<?php echo e(route('login.simple-post')); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="flex items-center justify-between space-x-reverse space-x-2 w-full">
        ...
        <div>
            <a href="<?php echo e(route('forgotPassword')); ?>" class="text-mini-base text-sky-600 underline underline-offset-8">فراموشی رمز عبور</a>
        </div>
    </div>
    <div class="flex items-center justify-between space-x-reverse space-x-1.5 w-full">
        <div class="flex items-center space-x-reverse space-x-2">
            ...
            <a class="text-mini-base text-sky-600 underline underline-offset-8" href="<?php echo e(route('register')); ?>">ثبت نام</a>
        </div>
    </div>
...
<?php echo $__env->make('Auth.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\merikhArz\resources\Merikharz/Auth/login.blade.php ENDPATH**/ ?>