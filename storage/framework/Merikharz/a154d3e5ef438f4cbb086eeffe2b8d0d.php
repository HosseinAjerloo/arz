...
<form class="flex flex-col justify-center items-center space-y-6 py-2 pb-6  border-b border-black/40" method="POST" action="<?php echo e(route('post.update.Password',$otp->token)); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="flex items-center space-x-reverse space-x-2 w-full border-black border-2 px-2 h-12 rounded-md">
        ...
        <input type="password"
               class="w-full h-full py-1.5 outline-none px-2  placeholder:text-center  placeholder:text-sm"
               placeholder="تکرار کلمه عبور" name="password">
    </div>
...
<?php echo $__env->make('Auth.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\merikhArz\resources\Merikharz/Auth/updatePassword.blade.php ENDPATH**/ ?>