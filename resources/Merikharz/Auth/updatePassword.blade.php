...
@endsection
@section('content')
<form class="container mx-auto w-full md:w-1/2 lg:w-1/3 flex flex-col justify-center items-center space-y-6 py-2 pb-6  border-b border-black/40" method="POST" action="{{route('post.update.Password',$otp->token)}}">
    @csrf
