        ...
        <article class="flex flex-col justify-start space-y-2 p-2 ">
            <form action="" class="space-y-4">
                ...
                <div class="flex items-center   rounded-lg space-x-2 space-x-reverse">
                    <img src="{{asset('merikhArz/src/images/seke.svg')}}" alt="">
                    <h1 class="text-sm">
                        موجودی فعلی شما <span class="text-mini-mini-base font-bold   @if($user->getCreaditBalance()>0) text-green-600  @else text-rose-700 @endif">{{$user->getCreaditBalance()}}</span> تومان میباشد
                    </h1>
                </div>
